...
const Navbar = ({ page }) => {
    ...
    return (
        <nav className="sm:w-fit w-[100vw] fixed sm:absolute sm:right-0 bottom-0 sm:bottom-auto left-0 sm:left-auto sm:top-0 bg-[#282829] p-5 rounded-bl-xl rounded-tr-xl">
